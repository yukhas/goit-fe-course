...
function createUserCard() {
    ...
    divImg.innerHTML = '<img src="images/photo.jpg" alt="claudia cardinale photo">';

    userName.innerHTML = 'Claudia Cardinale';
    addInfo.innerHTML = '<span class ="number">29</span><span>Philadelphia, PA</span>';
    ...
    divNumber1.innerHTML = '19';
    divNumber2.innerHTML = '5';
